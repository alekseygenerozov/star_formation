...
edotMSSpecific[t_?NumericQ, mhalo_]:=NIntegrate[dNdtForm[z[t1],mhalo] enStarInt[Mt0Fit[t1]],{t1, 0,tL[zu]}, Method->"AdaptiveQuasiMonteCarlo"]\
/NIntegrate[dNdtForm[z[t1],mhalo],{t1, 0,tL[zu]}]
